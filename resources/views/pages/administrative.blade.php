    ...
    <div class="grid lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-etec-main rounded-2xl shadow-sm overflow-hidden border border-etec-dark/30 dark:border-white/10 sticky top-24">
                ...
                <div class="px-6">
                    <div class="w-24 h-24 mx-auto -mt-12 bg-white rounded-full p-1 shadow-lg overflow-hidden">
        ...
        <div class="lg:col-span-2 space-y-10">
            ...
            {{-- Acesso Rápido --}}
            <div>
                <h2 class="text-xl font-bold text-etec-dark dark:text-white mb-5 border-l-4 border-etec-accent pl-3 flex items-center gap-2">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    ...
                    <a href="{{ $link['url'] }}" target="_blank"
                       class="bg-etec-main border border-etec-dark/30 dark:border-white/10 p-4 rounded-xl hover:shadow-lg hover:shadow-etec-dark/30 hover:border-etec-accent hover:-translate-y-1 transition group text-center flex flex-col items-center gap-2">
                        <div class="text-2xl bg-white/10 w-14 h-14 rounded-xl flex items-center justify-center group-hover:bg-etec-accent/30 transition font-bold">
                            {{ $link['icon'] }}
                        </div>
                        <div>
