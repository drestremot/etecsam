...
<div class="container mx-auto px-4 py-12 space-y-14">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="p-8 md:p-12 flex flex-col justify-center">
                <div class="flex items-center gap-2 mb-3">
                    <span class="inline-flex items-center gap-1.5 bg-etec-accent/10 text-etec-dark text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full">
                ...
                <h2 class="text-3xl font-bold text-gray-800 mb-1">{{ $director->name }}</h2>
                <p class="text-etec-medium font-semibold mb-4">{{ $director->role }}</p>

                @if($director->specialty)
                <p class="text-gray-600 leading-relaxed mb-6 max-w-xl">{{ $director->specialty }}</p>
                @endif

                <div class="flex flex-wrap gap-3">
                    @if($director->email)
                    <a href="mailto:{{ $director->email }}"
                       class="inline-flex items-center gap-2 px-5 py-2.5 border border-gray-200 text-gray-600 rounded-lg font-semibold text-sm hover:border-etec-accent hover:text-etec-dark transition">
                    ...
                    <a href="tel:{{ preg_replace('/\D/', '', $director->phone) }}"
                       class="inline-flex items-center gap-2 px-5 py-2.5 bg-etec-light text-etec-dark rounded-lg font-semibold text-sm hover:bg-etec-medium hover:text-white transition">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $director->lattes_url }}" target="_blank"
                       class="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-100 text-gray-700 rounded-lg font-semibold text-sm hover:bg-gray-200 transition">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-gray-50 rounded-2xl p-10 text-center border border-dashed border-gray-300">
        ...
        <p class="text-gray-500">Informações da direção em atualização.</p>
    </div>
    @endif

    {{-- Sobre a Gestão --}}
    <div class="grid md:grid-cols-3 gap-6">
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex gap-4">
            <div class="w-12 h-12 bg-etec-light text-etec-main rounded-xl flex items-center justify-center flex-shrink-0">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/>
                </svg>
            </div>
            <div>
                <h3 class="font-bold text-gray-800 mb-1">Missão</h3>
                <p class="text-sm text-gray-500 leading-relaxed">Garantir a excelência no ensino técnico e a formação integral dos estudantes.</p>
            </div>
        </div>
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex gap-4">
            <div class="w-12 h-12 bg-etec-light text-etec-main rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div>
                <h3 class="font-bold text-gray-800 mb-1">Visão</h3>
                <p class="text-sm text-gray-500 leading-relaxed">Ser referência regional em educação técnica agrícola e profissional de qualidade.</p>
            </div>
        </div>
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex gap-4">
            <div class="w-12 h-12 bg-etec-light text-etec-main rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div>
                <h3 class="font-bold text-gray-800 mb-1">Valores</h3>
                <p class="text-sm text-gray-500 leading-relaxed">Ética, respeito, inovação e compromisso com a comunidade escolar.</p>
            </div>
        </div>
    </div>
    ...
    @if($staff->isNotEmpty())
    <div>
        <h2 class="text-xl font-bold text-gray-800 mb-6 border-l-4 border-etec-accent pl-3">Equipe de Apoio à Direção</h2>
    ...
    <div>
        <h2 class="text-xl font-bold text-gray-800 mb-6 border-l-4 border-etec-medium pl-3">Estrutura de Gestão</h2>
        <div class="grid md:grid-cols-2 gap-5">
            <a href="{{ route('academic-division') }}"
               class="group bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex items-center gap-5 hover:border-etec-medium hover:shadow-md transition">
                <div class="w-14 h-14 bg-blue-50 text-etec-main rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-etec-medium group-hover:text-white transition">
            ...
            <a href="{{ route('administrative') }}"
               class="group bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex items-center gap-5 hover:border-etec-medium hover:shadow-md transition">
                <div class="w-14 h-14 bg-amber-50 text-amber-600 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-etec-medium group-hover:text-white transition">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                </div>
                <div class="flex-grow">
                    <h3 class="font-bold text-gray-800 group-hover:text-etec-main transition">Diretoria de Serviços</h3>
                    <p class="text-sm text-gray-500">Gestão administrativa, financeira e de infraestrutura</p>
                </div>
                <svg class="w-5 h-5 text-gray-300 group-hover:text-etec-medium transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                </svg>
