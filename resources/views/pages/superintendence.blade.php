...
<div class="container mx-auto px-4 py-12 space-y-14">
    ...
    <div class="bg-etec-main rounded-2xl shadow-sm overflow-hidden border border-etec-dark/30 dark:border-white/10">
        <div class="flex flex-col md:flex-row">
            ...
            <div class="p-8 md:p-12 flex flex-col justify-center">
                ...
                @if($director->bio)
                <div class="bg-white/10 rounded-xl p-4 text-left mt-4">
    ...
    @if($staff->isNotEmpty())
    <div>
        <h2 class="text-xl font-bold text-white mb-6 border-l-4 border-etec-accent pl-3">Equipe de Apoio à Direção</h2>
