...
{{-- Hero --}}
<x-page-header label="Gestão Escolar" title="Gestão Pedagógica" subtitle="Coordenação, Orientação Educacional e Cursos Técnicos">
    <x-slot:icon>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                        ...
                        <div class="bg-[#14284b] rounded-2xl shadow-sm border border-white/10 p-5 flex gap-4 hover:border-amber-400/40 hover:shadow-lg transition items-start min-w-0">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                @if($member->specialty)
                                <p class="text-xs text-slate-300 mt-1 mb-2 leading-relaxed line-clamp-2">{{ $member->specialty }}</p>
                                @endif
