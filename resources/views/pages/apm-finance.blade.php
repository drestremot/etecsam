...
<div class="container mx-auto px-4 py-12 space-y-10">
    ...
    <div class="mb-2">
        <a href="{{ route('apm') }}" class="inline-flex items-center gap-1.5 text-sm text-etec-medium dark:text-etec-accent hover:underline">
    ...
    <div>
        ...
        <div class="grid md:grid-cols-3 gap-5">
            ...
            <div class="bg-etec-main rounded-2xl shadow-sm border border-etec-dark/30 dark:border-white/10 p-6">
                <p class="text-xs font-bold text-etec-light uppercase tracking-widest mb-2">Saídas</p>
    ...
    <div>
        ...
        <div class="grid md:grid-cols-2 gap-5">
            ...
            <div class="bg-etec-main rounded-2xl shadow-sm border border-etec-dark/30 dark:border-white/10 p-6">
                <p class="text-xs font-bold text-etec-light uppercase tracking-widest mb-2">A Receber (entradas futuras)</p>
                <p class="text-xl font-bold text-white">R$ {{ number_format($upcomingIncomes, 2, ',', '.') }}</p>
            </div>
        </div>
    </div>
