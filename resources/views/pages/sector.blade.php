    ...
    <div class="grid lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div>
                ...
                <div class="bg-etec-light/40 border border-etec-light rounded-xl p-6 mt-6">
                    <h4 class="font-bold text-etec-dark mb-3 flex items-center gap-2">
                    ...
                    <ul class="space-y-2 text-sm text-etec-dark">
                        <li class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-etec-medium flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        ...
        <div class="space-y-6">
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-6">
                <h4 class="font-bold text-gray-800 text-lg mb-5">Destaques</h4>
                <ul class="space-y-4">
                ...
                <div class="mt-8 pt-6 border-t border-gray-100">
                    <a href="{{ route('home') }}#fazenda"
                       class="flex items-center justify-center gap-2 w-full py-3 border-2 border-etec-dark text-etec-dark font-bold rounded-xl hover:bg-etec-dark hover:text-white transition text-sm">
