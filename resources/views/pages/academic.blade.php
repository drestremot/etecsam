...
<div class="container mx-auto px-4 py-12">
    ...
    <div class="mb-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <a href="{{ $link['url'] }}" target="_blank"
               class="bg-white border border-gray-200 p-4 rounded-xl hover:shadow-lg hover:border-etec-accent hover:-translate-y-1 transition group text-center flex flex-col items-center gap-2 h-full">
                <div class="text-2xl bg-blue-50 text-blue-600 w-14 h-14 rounded-xl flex items-center justify-center group-hover:bg-etec-light group-hover:text-etec-dark transition font-bold">
                    {{ $link['icon'] }}
                </div>
                <div>
    ...
    <div class="grid lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
                ...
                <div class="p-6 pt-3 text-center">
                    ...
                    <span class="text-xs font-bold text-etec-medium uppercase tracking-wide block mb-4">{{ $director->role }}</span>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 text-sm text-left space-y-3">
                        ...
                        <div class="flex items-center gap-2.5">
                            ...
                            <a href="mailto:{{ $director->email }}" class="text-blue-600 hover:underline truncate">{{ $director->email }}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-2">
            <h2 class="text-xl font-bold text-gray-800 mb-6 border-l-4 border-etec-medium pl-3">Equipe de Atendimento</h2>
            ...
            <div class="grid md:grid-cols-2 gap-5">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex gap-4 hover:shadow-md transition">
                    ...
                    <div class="min-w-0">
                        ...
                        <span class="text-xs font-bold text-gray-400 uppercase tracking-wide block mb-1.5">{{ $member->role }}</span>
                        <p class="text-xs text-gray-500 mb-2 leading-relaxed">{{ $member->specialty }}</p>
                        <a href="mailto:{{ $member->email }}" class="inline-flex items-center gap-1 text-xs text-blue-600 hover:underline">
    ...
    <div class="mt-12 bg-blue-50 rounded-2xl p-8 border border-blue-100">
        ...
        @else
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-start gap-4 hover:border-blue-300 transition group">
                    <div class="w-10 h-10 bg-red-50 text-red-500 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-red-500 group-hover:text-white transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    </div>
                    <div class="flex-grow min-w-0">
                        <h4 class="font-bold text-gray-800 text-sm mb-1.5 leading-tight">{{ $file->title }}</h4>
                        <a href="{{ $file->file_path }}" class="inline-flex items-center gap-1 text-xs font-bold text-blue-600 hover:text-blue-800 transition">
