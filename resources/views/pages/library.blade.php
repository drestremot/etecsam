...
<div class="container mx-auto px-4 py-12 grid lg:grid-cols-3 gap-10">
    ...
    <aside class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden text-center">
            ...
            <div class="px-6 pt-0 pb-6 relative">
                ...
                <h3 class="text-lg font-bold text-gray-800 mt-3">Esther do Nascimento Martins</h3>
                <span class="text-xs text-etec-medium font-bold uppercase tracking-wider">Bibliotecária</span>

                <div class="mt-5 text-left space-y-3 text-sm bg-gray-50 p-4 rounded-xl">
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <a href="mailto:biblioteca@etec.sp.gov.br" class="text-blue-600 hover:underline text-xs">biblioteca@etec.sp.gov.br</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="lg:col-span-2 space-y-10">
        ...
        {{-- Bases de pesquisa --}}
        <div>
            <h2 class="text-xl font-bold text-gray-800 mb-6 border-l-4 border-etec-medium pl-3 flex items-center gap-2">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <a href="https://www.periodicos.capes.gov.br/" target="_blank"
                   class="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl hover:shadow-md hover:border-blue-400 transition group">
                    ...
                    <div>
                        <strong class="block text-gray-800 group-hover:text-blue-700 transition">Portal CAPES</strong>
                        <span class="text-xs text-gray-500">Periódicos científicos</span>
                    </div>
                    <svg class="w-4 h-4 text-gray-300 ml-auto group-hover:text-blue-400 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                </a>

                <a href="https://scielo.org/" target="_blank"
                   class="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl hover:shadow-md hover:border-orange-400 transition group">
                    ...
                    <div>
                        <strong class="block text-gray-800 group-hover:text-orange-700 transition">SciELO</strong>
                        <span class="text-xs text-gray-500">Biblioteca Eletrônica</span>
                    </div>
                    <svg class="w-4 h-4 text-gray-300 ml-auto group-hover:text-orange-400 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                </a>

                <a href="https://scholar.google.com.br/" target="_blank"
                   class="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl hover:shadow-md hover:border-blue-300 transition group">
                    <div class="w-12 h-12 bg-blue-50 text-blue-500 rounded-xl flex items-center justify-center flex-shrink-0 font-bold text-lg">
                        G
                    </div>
                    <div>
                        <strong class="block text-gray-800 group-hover:text-blue-600 transition">Google Acadêmico</strong>
                        <span class="text-xs text-gray-500">Pesquisa ampla e gratuita</span>
                    </div>
                    <svg class="w-4 h-4 text-gray-300 ml-auto group-hover:text-blue-400 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                </a>

                <a href="http://www.dominiopublico.gov.br/" target="_blank"
                   class="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-xl hover:shadow-md hover:border-green-400 transition group">
                    ...
                    <div>
                        <strong class="block text-gray-800 group-hover:text-green-700 transition">Domínio Público</strong>
                        <span class="text-xs text-gray-500">Obras literárias gratuitas</span>
                    </div>
                    <svg class="w-4 h-4 text-gray-300 ml-auto group-hover:text-green-400 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                </a>
            </div>
        </div>
        ...
        {{-- Documentos --}}
        <div>
            <h2 class="text-xl font-bold text-gray-800 mb-6 border-l-4 border-etec-accent pl-3 flex items-center gap-2">
            ...
            @if($documents->isEmpty())
                <div class="py-10 text-center bg-gray-50 rounded-xl border border-dashed border-gray-200">
                    ...
                    <p class="text-gray-500 text-sm">Nenhum documento disponível no momento.</p>
                </div>
            @else
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 divide-y divide-gray-100">
                    @foreach($documents as $doc)
                    <div class="p-4 flex items-center gap-4 hover:bg-gray-50 transition group">
                        <div class="w-10 h-10 bg-etec-light text-etec-dark rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-etec-dark group-hover:text-white transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        </div>
                        <div class="flex-grow min-w-0">
                            <h4 class="font-bold text-gray-800 text-sm leading-tight">{{ $doc->title }}</h4>
                            <span class="text-xs text-gray-400">Atualizado em {{ \Carbon\Carbon::parse($doc->published_at)->format('d/m/Y') }}</span>
                        </div>
                        <a href="{{ $doc->file_path }}"
                           class="flex-shrink-0 inline-flex items-center gap-1.5 bg-etec-light text-etec-dark px-4 py-2 rounded-lg text-xs font-bold hover:bg-etec-medium hover:text-white transition">
