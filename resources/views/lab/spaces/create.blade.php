...
<div class="max-w-xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Novo Espaço Didático</h1>
    </div>
    <form action="{{ route('lab.spaces.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 space-y-5">
        @csrf
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Nome *</label>
            <input type="text" name="name" value="{{ old('name') }}" required placeholder="Ex: Laboratório de Informática"
        ...
        <div>
            ...
            <textarea name="description" rows="3" placeholder="Capacidade, equipamentos, localização..."
