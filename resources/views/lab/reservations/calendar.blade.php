    ...
    <div class="bg-white rounded-2xl p-6 w-full max-w-lg shadow-2xl border border-gray-100 transform transition-all scale-100">
        ...
        <div class="flex items-center justify-end gap-2.5 pt-3 border-t border-gray-100">
            <a id="modalEventPdfBtn" href="#" target="_blank" class="inline-flex items-center gap-1 rounded-xl bg-gray-800 px-3.5 py-2 text-xs font-bold text-white shadow-2xs hover:bg-gray-700 transition">
                <svg class="w-4 h-4 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg> Imprimir PDF
            </a>
            ...
            eventContent: function(arg) {
                ...
                customEl.innerHTML = `
                    ...
                    <div class="text-[9.5px] font-medium opacity-95 truncate mt-0.5">
                        <svg class="w-4 h-4 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg> ${teacherName}
                    </div>
                `;
