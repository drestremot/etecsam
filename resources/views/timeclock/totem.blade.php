        ...
        <div class="md:col-span-6 bg-gray-900/80 border border-gray-800 rounded-3xl p-6 sm:p-8 space-y-5 shadow-2xl backdrop-blur-md">
            ...
            <button type="button" @click="punchTotem()" :disabled="!selectedUser || submitting"
                ...
                <template x-if="!submitting">
                    <span x-text="selectedUser ? '<svg class="w-4 h-4 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg> CONFIRMAR PONTO DE ' + selectedUser.name.split(' ')[0].toUpperCase() : 'SELECIONE SEU NOME ACIMA'"></span>
                </template>
                <template x-if="submitting">
