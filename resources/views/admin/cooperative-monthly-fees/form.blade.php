...
<div class="max-w-2xl">
    ...
    <div class="mb-4">
        <a href="{{ route('admin.cooperative-monthly-fees.index') }}" class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-indigo-600 transition">
            ← Voltar para lista
        </a>
    </div>

    <form action="{{ $action === 'create' ? route('admin.cooperative-monthly-fees.store') : route('admin.cooperative-monthly-fees.update', $cooperativeMonthlyFee) }}"
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="month" name="month"
                           value="{{ old('month', $cooperativeMonthlyFee->month ? $cooperativeMonthlyFee->month->format('Y-m') : '') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="amount" step="0.01" min="0"
                           value="{{ old('amount', $cooperativeMonthlyFee->amount) }}" required
