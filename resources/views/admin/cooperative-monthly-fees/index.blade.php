...
@section('page-title', 'Valores das Mensalidades')

@section('header-actions')
    <a href="{{ route('admin.cooperative-monthly-fees.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-lg">+ Novo Mês</a>
@endsection
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center justify-end gap-1">
                        <a href="{{ route('admin.cooperative-monthly-fees.edit', $fee) }}" title="Editar"
    ...
    <div class="px-4 py-3">{{ $cooperativeMonthlyFees->links() }}</div>
</div>
@endsection
