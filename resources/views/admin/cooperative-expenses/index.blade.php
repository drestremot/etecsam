...
@section('page-title', 'Despesas da Cooperativa')

@section('header-actions')
    <a href="{{ route('admin.cooperative-expenses.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-lg">+ Nova Despesa</a>
@endsection
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <table class="min-w-full divide-y divide-gray-200 text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center justify-end gap-1">
                        ...
                        <a href="{{ route('admin.cooperative-expenses.edit', $expense) }}" title="Editar"
            ...
            @empty
            <tr><td colspan="6" class="px-4 py-8 text-center text-gray-400">Nenhuma despesa cadastrada ainda.</td></tr>
            @endforelse
        </tbody>
    </table>
    <div class="px-4 py-3">{{ $cooperativeExpenses->links() }}</div>
</div>
@endsection
