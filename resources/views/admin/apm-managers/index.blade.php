...
@section('page-title', 'Gestão e Cargos da APM')

@section('header-actions')
    <a href="{{ route('admin.apm-managers.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-lg">+ Novo</a>
@endsection
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden" x-data="adminTable()">
            ...
            <tr class="hover:bg-gray-50 {{ !$manager->is_active ? 'opacity-60' : '' }}"
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center justify-end gap-1">
                        ...
                        <a href="{{ route('admin.apm-managers.edit', $manager) }}" title="Editar"
    ...
    <div class="px-4 py-3">{{ $apmManagers->links() }}</div>
</div>
