...
@section('page-title', $action === 'create' ? 'Novo Documento da Cooperativa' : 'Editar Documento')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        ...
                        <label class="flex items-center gap-2 p-3 rounded-lg border-2 cursor-pointer transition text-sm
                            {{ old('category', $cooperativeReport->category) === $cat ? 'border-indigo-500 bg-indigo-50 text-indigo-700 font-semibold' : 'border-gray-200 hover:border-gray-300 text-gray-600' }}">
                            <input type="radio" name="category" value="{{ $cat }}"
                                   {{ old('category', $cooperativeReport->category) === $cat ? 'checked' : '' }}
