    ...
    <div class="w-full max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <div class="flex items-center gap-2 text-xs font-bold text-gray-500 mb-1">
                    ...
                    <span>/</span>
                    <span class="text-indigo-600 font-extrabold">{{ $action === 'create' ? 'Novo Horário' : 'Editar Horário' }}</span>
                </div>
            ...
            <a href="{{ route('admin.work-schedules.index') }}" class="rounded-xl bg-white border border-gray-300 px-4 py-2 text-xs font-semibold text-gray-700 shadow-2xs hover:bg-gray-50 transition">
                Voltar
            </a>
        </div>

        @if($errors->any())
            <div class="rounded-2xl bg-rose-50 border border-rose-200 p-4 text-xs font-semibold text-rose-800 space-y-1">
        ...
        <form method="POST"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Professor / Colaborador *</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Unidade Escolar *</label>
            ...
            <!-- 2. Dias da Semana -->
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase mb-2">Dias da Semana *</label>
                @if($action === 'create')
                    <div class="grid grid-cols-2 sm:grid-cols-6 gap-2">
                        ...
                        <label class="cursor-pointer rounded-2xl border border-gray-200 p-3 text-center transition hover:bg-gray-50 flex flex-col items-center justify-center gap-1.5 has-checked:border-indigo-600 has-checked:bg-indigo-50/50 has-checked:text-indigo-900">
                            ...
                            <span class="text-xs font-bold block">{{ substr($dayName, 0, 3) }}</span>
            ...
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Identificação do Turno / Matéria (Opcional)</label>
                <input type="text" name="shift_name" value="{{ old('shift_name', $schedule->shift_name) }}"
                       ...
                       class="w-full rounded-2xl border border-gray-300 px-3.5 py-2.5 text-xs sm:text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-400">
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-2xl border border-gray-200">
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Horário de Entrada *</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Horário de Saída *</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Início do Intervalo</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Fim do Intervalo</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1.5">Tolerância (minutos)</label>
            ...
            <div class="pt-4 flex items-center justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.work-schedules.index') }}" class="rounded-2xl border border-gray-300 px-5 py-3 text-xs font-bold text-gray-700 hover:bg-gray-50 transition">
                    Cancelar
                </a>
                <button type="submit" class="rounded-2xl bg-indigo-600 px-6 py-3 text-xs font-bold text-white hover:bg-indigo-500 shadow-md shadow-indigo-200 transition">
