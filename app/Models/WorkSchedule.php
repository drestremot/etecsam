    ...
    public static function getDayColorConfig(): array
    {
        return [
            1 => [
                'name'        => 'Segunda-feira',
                'short'       => 'SEG',
                'badge_class' => 'bg-sky-50 text-sky-700 border-sky-300/80 shadow-2xs',
                'bg_solid'    => 'bg-sky-600',
            ...
            3 => [
                'name'        => 'Quarta-feira',
                'short'       => 'QUA',
                'badge_class' => 'bg-amber-50 text-amber-800 border-amber-300/80 shadow-2xs',
                'bg_solid'    => 'bg-amber-600',
            ...
            6 => [
                'name'        => 'Sábado',
                'short'       => 'SÁB',
                'badge_class' => 'bg-teal-50 text-teal-700 border-teal-300/80 shadow-2xs',
                'bg_solid'    => 'bg-teal-600',
