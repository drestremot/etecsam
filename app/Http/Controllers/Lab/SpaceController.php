...
class SpaceController extends Controller
{
    ...
    {
        $spaces = Space::with('auxiliar')->orderBy('name')->get();
    ...
    public function create()
    {
        ...
        return view('lab.spaces.create', compact('auxiliares'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Space::create($request->only('name', 'description', 'auxiliar_id'));
    ...
    {
        $auxiliares = User::role('Auxiliar')->where('is_active', true)->orderBy('name')->get();
        return view('lab.spaces.edit', compact('space', 'auxiliares'));
    }
    ...
    public function update(Request $request, Space $space)
    {
        ...
        $space->update($request->only('name', 'description', 'auxiliar_id'));
